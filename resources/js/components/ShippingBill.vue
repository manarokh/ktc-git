           ...
           <div class="w-full">
               ...
               class="lg:flex items-center mb-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <a v-bind:href="path"  class="h-3 mr-2">
                            <i class="material-icons h-3 -m-1 ml-1" >mode_edit</i>
                        </a>

                        <a :href="printpath" class="h-3 mr-0">
                            <i class="material-icons h-3 -m-1 ml-1" >print</i>
                        </a>
...
<script>
export default {
    props : ['task','bills','path','printpath'],
    data() {
        return {
            isOpen : false,
