<template>
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        <form @submit.prevent="submit" style="direction:rtl">
            <div>
                <h1 class="capitalize font-normal mb-16 text-center text-default text-2xl">إنشاء زبون جديد</h1>

                <div class="flex">
                    <!-- left side -->
                    <div class="flex-1 mr-4 ml-2">
                        <div class="mb-4">
                            <label for="title" class="font-normal text-default block mb-2">اسم الزبون</label>
                            <input 
                            type="text" 
                            name="title" 
                            id="title" 
                            class="py-1 px-2 bg-default w-full rounded " 
                            placeholder="خلوف أوتو"
                        ...
                        <div class="mb-4">
                            <label for="description" class="font-normal text-default block mb-2">تفاصيل</label>
                            <textarea
                            name="description" 
                            id="description"
                            ...
                            placeholder="معرض شركة خلوف للسيارات"></textarea>
                    ...
                    <footer class="flex justify-end">
                        <button 
                        type="button" 
                        class="button-primary capitalize font-bold ml-2 is-outlined"
                        @click="$modal.hide('new-project')">
                        إالغاء</button>
                        <button type="submit" class="button-primary capitalize">إنشاء</button>
                    </footer>
            </div>
        </form>
    </modal>
